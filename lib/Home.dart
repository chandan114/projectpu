    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          children: <Widget>[
            ...
            Fb(imgUrl: 'logo/facebook1.png',
                      titles: "Enrollment number",),
          Signupclick(imgUrl: 'logo/facebook1.png',
                titles: "SIGNUP",),
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Image.asset(imgUrl , height: 20,),
                  ),
                  SizedBox(width: 50),
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left:20.0),
                      child: Image.asset(imgUrl , height: 25,),
                    ),
                    SizedBox(width: 50),
                    Text(titles , style: TextStyle(
                      fontFamily: 'Anveri',
